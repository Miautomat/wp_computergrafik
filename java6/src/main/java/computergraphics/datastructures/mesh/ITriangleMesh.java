/**
 * Prof. Philipp Jenke Hochschule für Angewandte Wissenschaften (HAW), Hamburg
...
public interface ITriangleMesh {
    /**
     * Add a new vertex (given by position) to the vertex list. The new vertex
    ...
    /**
     * Create a mesh of the shadow polygons. lightPosition: Position of the
     * light source. extend: Length of the polygons shadowPolygonMesh: Result is
     * put in there
     */
