...
public class RectangleNode extends LeafNode {
   ...
   * Constructor.
   */
  public RectangleNode(double length, double depth, double height) {
    this.length = length;
    this.depth = depth;
    this.height = height;
    createVbo();
...
//    depth=length;
    ...
    Vector p0 = new Vector(-length, -height, -depth);
    Vector p1 = new Vector(length, -height, -depth);
    Vector p2 = new Vector(length, height, -depth);
    Vector p3 = new Vector(-length, height, -depth);
    Vector p4 = new Vector(-length, -height, depth);
    Vector p5 = new Vector(length, -height, depth);
    Vector p6 = new Vector(length, height, depth);
    Vector p7 = new Vector(-length,height, depth);
