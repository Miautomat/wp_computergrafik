...
public class FloorNode extends LeafNode {
   ...
   * Constructor.
   */
  public FloorNode(double sideLength) {
  ...
  private void createVbo() {
    ...
    Vector p2 = new Vector(sideLength, 0, -sideLength);
    Vector p3 = new Vector(-sideLength, 0, -sideLength);
    Vector p4 = new Vector(-sideLength, 0, sideLength);
    Vector p5 = new Vector(sideLength, 0, sideLength);
    Vector p6 = new Vector(sideLength, 0, sideLength);
    Vector p7 = new Vector(-sideLength, 0, sideLength);
    ...
    Vector color = new Vector(0, 0.75, 0, 1);
